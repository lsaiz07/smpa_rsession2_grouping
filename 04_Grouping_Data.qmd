...
```{r} 
library(readxl)
sarasota_q1_flights <- read_excel("data/sarasota_q1_flights.xlsx", 
    sheet = "Sheet1")
View(sarasota_q1_flights)


flights_singleairport <- read_excel("data/sarasota_q1_flights.xlsx")
...
srqflights 
  filter(origin == "LGA", month == 1, sched_dep_time < 1200)
